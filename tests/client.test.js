...
import Shirts from '../client/src/components/Shirts.jsx';
import CompareAtGlance from '../client/src/components/CompareAtGlance.jsx';
import PeopleAlsoViewed from '../client/src/components/CompareAtGlance.jsx';
...
describe('Shirts component ', () => {
  test('render title for People also viewed', () => {
    ...
    let text = findByText('People also', w).text();
